...
<html>
    ...
    <body class="skin-<?php echo $panelInit->settingsArray['layoutColor']; ?> fixed" ng-app="schoex" ng-controller="mainController">
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <div class="pull-right footerCopyRight" style='margin:20px;'><?php echo $panelInit->settingsArray['footer']; ?> - <a target="_BLANK" href="{{URL::to('/terms')}}">Terms & Condition</a></div>
        </div>
